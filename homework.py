class InfoMessage:
    ...
    def __init__(self,
                 training_type: str,
                 duration: float,  # время тренирови
                 distance: float,
                 speed: float,
                 calories: float):
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> None:
        return ((self.sp_walk1 * self.weight + ((self.get_mean_speed()
                 * self.multiplier_speed) ** 2
                 / (self.height / self.CM_IN_M)) * self.sp_walk2
